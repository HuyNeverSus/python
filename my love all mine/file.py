...
pygame.display.set_caption("my love all mine")
font = pygame.font.Font("Shooting Star.ttf", 58)
clock = pygame.time.Clock()

# ==== VIDEO SETUP ====
video_path = r"C:\Users\tranv\Downloads\python\my love all mine\file.mp4"
...
lyrics = [
    ("Shinin'... ", 120, 0.8),
    ("down on me", 150, 1.2),
    ("Moon, tell me if i could", 100, 1.2),
    ("Send up my heart to you?", 100, 1.2),
    ("So when i die, which i must do", 80, 0.6),
    ("Could it shineeeee down here with you?", 80, 1),
    ("'Cause my love is mine, all mine", 100, 1.1),
    ("My love mine, mine, mine", 100, 1.1),
    ("Nothing in the world belongs to me", 60, 1.1),   
    ("But my love, mine, all mine, all mine", 100, 1.5),
]
...
def draw_song_info(surface):
    ...
    overlay.blit(title_font.render("My Love Mine All Mine", True, (255, 230, 200)), (80, 18))
    overlay.blit(artist_font.render("Mitski", True, (230, 230, 230)), (80, 50))
